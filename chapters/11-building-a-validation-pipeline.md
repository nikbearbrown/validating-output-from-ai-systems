...
**4. Human.** Review engineered with cognitive forcing functions, adversarial framing, bounded scope, and risk-proportional approval (Chapter 10). The human is the last oracle — and Lucy Bainbridge's "Ironies of Automation" (1983) tells you why this slice is thin and goes last: the human is asked to catch exactly the residual cases the automation could not, the hardest ones, while being de-skilled by not seeing the routine cases. The human slice is a real defense only if you design it to be.
